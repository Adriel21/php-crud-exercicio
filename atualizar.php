...
<div class="container">
    ...
    <form action="#" method="post">
	    ...
	    <input name="primeira" type="number" id="primeira" step="0.1" min="0.0" max="10" oninput="verNota()" required value="<?=$aluno["primeira"]?>" ></p>
	    
	    <p><label for="segunda">Segunda nota:</label>
	    <input name="segunda" type="number" id="segunda" step="0.1" min="0.0" max="10" oninput="verNota()" required value="<?=$aluno["segunda"]?>" ></p>

        <p>
        <!-- Campo somente leitura e desabilitado para edição.
        Usado apenas para exibição do valor da média -->
            <label for="media">Média:</label>
            <input name="media" type="number" id="media" step="0.1" min="0.0" max="10" readonly disabled value="<?=$aluno["media"]?>">
        </p>
        ...
        Usado apenas para exibição do texto da situação -->
	        ...
	        <input type="text" name="situacao" id="situacao" readonly disabled value="<?=$aluno["situacao"]?>">
        </p>
	    
        <button name="atualizar-dados" class="btn btn-success">Atualizar dados do aluno</button>
	</form>    
    
    <hr>
    <p><a href="visualizar.php" class="btn btn-primary">Voltar à lista de alunos</a></p>
