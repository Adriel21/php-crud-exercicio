...
function lerAlunos (PDO $conexao): array {
    $sql = "SELECT id, nome, primeira, segunda, media, situacao FROM 
...
function inserirAluno(PDO $conexao, string $nome, float $primeira, float $segunda, float $media, string $situacao) {
...
function lerUmAluno(PDO $conexao, int $id):array {
    $sql = "SELECT id, nome, primeira, segunda, media, situacao
